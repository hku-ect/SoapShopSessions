...
Edited October 2018 by HKU ECT (https://www.hku.nl/OnderzoekEnExpertise/Expertisecentra/ExpertisecentrumCreatieveTechnologie.htm)
----------------------------------------------------------------------------------------------------
This application is waitng for an OSC message "/wek/outputs" where the accepted values are 1 & 2.
These values are generated by using FaceOSC in combination with Wekinator. 
Wekinator is trained on neutral faces (value 1) and on laughing faces (value 2)
This way the application makes a picture when you smile :)
----------------------------------------------------------------------------------------------------
